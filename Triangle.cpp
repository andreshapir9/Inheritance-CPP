#include "Triangle.h"  // class implemented
#include<string>
using namespace std;
...
Triangle::Triangle(const string& aColor, int aCoord, float aAngle) : Shape(aColor, aCoord), mAngle(aAngle) {
	this->SetTriangle(aColor, aCoord, aAngle);
}
...
void Triangle::SetTriangle(const string& aColor, int aCoord, float aAngle) {
